...
const produtos = [
  ...
  },
  {
    ...
    descricao: {
      ...
      comoUsar: "<p>Utilize a embalagem para o acondicionamento da formulação conforme sua finalidade. Siga as <strong>instruç��es do fabricante</strong> e, quando aplicável, a orientação de um profissional habilitado quanto ao preparo, acondicionamento e utilização da formulação.</p>",
  ...
  },
  {
    ...
    descricao: {
      ...
      comoUsar: "<p>Tomar <strong>1 cápsula</strong> após o café da manh�� ou almoço.</p>",
  ...
  },
  {
    ...
    descricao: {
      ...
      composicao: "<ul>\n<li>Bloomé — 500mg</li>\n<li>Excipiente qsp 1 cápsula</li>\n</ul><p><strong>Apresentaç��o:</strong> 30 Cápsulas</p>",
